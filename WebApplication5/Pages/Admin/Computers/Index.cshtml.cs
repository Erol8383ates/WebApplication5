...
namespace WebApplication5.Pages.Admin.Computers
{
    public class IndexModel : PageModel
    {
        ...
        public List<Computer> Computers { get; set; } = new List<Computer>(); // Initialize to avoid nullability issues
        ...
        public void OnGet(string searchNaam, string searchLokaal)
        {
            ...
            var query = _context.Computers.AsQueryable(); // Use DbSet<Computer> from ApplicationDbContext
